  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dashboard-header">
        <div>
          <h2 className="text">All Tickets</h2>
      ...
      <div className="summary-grid">
        ...
        <SummaryCard title="Assigned" value={counts.assigned} color="yellow" onClick={() => setFilter("ASSIGNED")} active={filter === "ASSIGNED"} />
...
function SummaryCard({ title, value, color, onClick, active }) {
  return (
    ...
    >
      ...
      <p className="text">{value} Tickets</p>
    </div>
  );
}
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="modal-section">
            <h4 className="text">Branch Information</h4>
          ...
          <div className="modal-section">
            <h4 className="text">Vehicle & Customer Information</h4>
            <div className="info-grid">
              <div>
          ...
          <div className="modal-section">
            <h4 className="text">Installation Address</h4>
