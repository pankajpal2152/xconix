    ...
    <div className="lender-page">
      ...
      <div className="fe-detail-wrapper">
        ...
        <div className="fe-detail-top">
          <div>
            <h2 className="text">{engineer.engineerCode}</h2>
        ...
        <div className="card-grid">
          <div className="card">
            <h4 className="text">Engineer Info</h4>
          ...
          <div className="card">
            <h4 className="text">Contact Info</h4>
            <p><b>Mobile:</b> {engineer.mobileNo}</p>
            <p><b>Email:</b> {engineer.emailId}</p>
          </div>

          <div className="card full">
            <h4 className="text">Location Details</h4>
        ...
        {/* SKILL SET */}
        <div className="card">
          <h4 className="text">Skill Set</h4>
        ...
        <div className="card-grid">
          <div className="card">
            <h4 className="text">Employment Details</h4>
        ...
        {/* TIMESTAMPS */}
        <div className="card">
          <h4 className="text">Record Information</h4>
